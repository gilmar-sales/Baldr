...
namespace BALDR_NAMESPACE
{
    ...
    {
        using ArgsTuple =
            std::tuple<Args...>; ///< Tuple of the callable's argument types.
    ...
    /**
     * @brief Specialisation for @c const @c operator() member function
     * pointers.
     */
    ...
    template <typename T, typename Ret, typename... Args>
    struct LambdaTraits<Ret (T::*)(Args...) noexcept>
        : LambdaTraits<Ret(Args...)>
    {
    };
     ...
     *        sequence.
     */
    template <typename TupleResult, typename Func, typename PtrFunc,
