...
- :material-puzzle: **Examples**
    ...
    [:octicons-arrow-right-24: Examples](authoring/examples.md)

</div>

## License

Baldr is released under the MIT License. See the [license page](community/license.md) for details.

## Stay in touch

- [GitHub repository](https://github.com/gilmar-sales/Baldr)
