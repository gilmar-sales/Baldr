...
[`examples/Devices`](https://github.com/gilmar-sales/Baldr/tree/main/examples/Devices) returns a list of `Device` records and a single device by id, with the typical 200 / 400 / 404 trio of typed results.
...
[`examples/Devices/src/Device.hpp`](https://github.com/gilmar-sales/Baldr/blob/main/examples/Devices/src/Device.hpp):
...
- See [Results](../../usage/results.md) for the typed result family.
